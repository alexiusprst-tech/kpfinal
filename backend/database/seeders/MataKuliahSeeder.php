...
class MataKuliahSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $courses = [
            ...
            [4, 'UCKXADB2', 'Bahasa Inggris', 'English', 2],
            ...
            [5, 'UBKXCCB2', 'Bahasa Indonesia', 'Indonesian Language', 2],
            ...
            [6, 'MK PILIHAN I', 'MK Pilihan Prodi I / MK MBKM / MK WRAP', 'Elective I', 3],
            [6, 'MK PILIHAN II', 'MK Pilihan Prodi II / MK MBKM / MK WRAP', 'Elective II', 3],
            ...
            [7, 'MK PILIHAN III', 'MK Pilihan Prodi III / MK MBKM / MK WRAP', 'Elective III', 3],
            [7, 'MK PILIHAN IV', 'MK Pilihan Prodi IV / MK MBKM / MK WRAP', 'Elective IV', 3],
            [7, 'MK PILIHAN V', 'MK Pilihan Prodi V / MK MBKM / MK WRAP', 'Elective V', 3],
