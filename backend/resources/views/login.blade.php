...
<body class="h-full bg-slate-100 flex flex-col lg:flex-row antialiased selection:bg-[#DD586F] selection:text-white">
    ...
    <div class="relative w-full lg:w-3/5 xl:w-[62%] min-h-[460px] lg:min-h-screen flex flex-col justify-between p-8 sm:p-12 lg:p-16 overflow-hidden bg-slate-900">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <!-- Subtle gradient overlay so building colors stay bright and vibrant while text stays readable -->
        ...
        <div class="w-full max-w-sm mx-auto my-auto py-4">
            ...
            @if ($errors->any())
                <div class="mb-5 p-3.5 rounded-xl bg-red-50 border border-red-200 text-red-700 text-xs font-semibold leading-relaxed flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-red-600 flex-shrink-0" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <form action="{{ url('/login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative flex items-center">
                        ...
                        <button type="button" id="togglePassword" aria-label="Lihat password" class="absolute right-3.5 text-slate-400 hover:text-slate-600 focus:outline-none cursor-pointer flex items-center justify-center p-1">
                            <!-- Eye Icon (Show) -->
                            <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-400 hover:text-slate-600 transition-colors duration-150" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                            </svg>
                            <!-- Eye Off Icon (Hide) -->
                            <svg id="eyeOffIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-400 hover:text-slate-600 transition-colors duration-150 hidden" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
